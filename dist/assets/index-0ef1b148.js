...
font-size: 14px;
font-weight: 600;
`,zw=()=>{const[e,t]=b.useState(0),[n,r]=b.useState(!1),[i,o]=b.useState([]),{toggleCarrinhoEstado:a}=b.useContext(on),{toggleCheckoutEstado:s}=b.useContext(on),{sacola:l,setSacola:u}=b.useContext(on);b.useEffect(()=>{t(l.reduce((p,g)=>p+g.preço,0))},[l]);const d=p=>{r(!n),o([p])};return I(vw,{children:[f(yw,{children:f(xw,{onClick:()=>{a()},src:"./img/close.png"})}),I(ww,{children:[l.length<1?I(kw,{children:[f(Sw,{children:"Carrinho"}),f(_w,{children:"Nenhum item ainda, vá comprar!"})]}):null,l.map(p=>I(Cw,{children:[f(Ew,{children:f(Pw,{src:p.url})}),I(Tw,{children:[f(Rw,{children:p.nome}),f(bw,{children:p.cor}),f(Aw,{children:`Size: ${p.tamanho}`}),f(Nw,{children:`${p.preço.toFixed(2)} R$`})]}),f(Ow,{onClick:()=>{u(l.filter(g=>g!==p))},src:"./img/trash.png"})]},p.id))]}),l.length>0?I(Iw,{children:[f(jw,{children:`R$ ${e.toFixed(2)}`}),f(Tt,{to:"/Checkout",children:f(Dw,{onClick:()=>{s()},children:"Finalizar Compra"})})]}):null,n?f(Jo,{data:i,func:d}):null]})},Wn={textDecoration:"none",color:"black"},$w=y.div`
    width: 20vw;
    height: 100vh;
    background-color: #ffffff;
    display: flex;
...
color: white;
margin-top: 3px;
`,xr=()=>{const{carrinhoEstado:e,toggleCarrinhoEstado:t}=b.useContext(on),{favorito:n}=b.useContext(qs),{sacola:r}=b.useContext(on);return I($w,{children:[e==="aberto"?f(zw,{}):null,f(Mw,{children:f(Tt,{to:"/",style:Wn,children:f(Fw,{src:"./img/logo.jfif"})})}),I(Lw,{children:[f(Tt,{to:"/",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/house.png"}),f(_r,{children:"Home"})]})}),f(Tt,{to:"/Perfil",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/account.png"}),f(_r,{children:"Profile"})]})}),f(Tt,{to:"/Camisas",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/shirt.png"}),f(_r,{children:"Tshirts"})]})}),f(Tt,{to:"/Bermudas",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/shorts.png"}),f(_r,{children:"Bermudas"})]})}),f(Tt,{to:"/FootWear",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/shoes.png"}),f(_r,{children:"FootWear"})]})}),f(Tt,{to:"/HeadWear",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/cap.png"}),f(_r,{children:"Headwear"})]})}),f(Tt,{to:"/Favorites",style:Wn,children:I(kr,{children:[f(Sr,{src:"./img/heart-full.png"}),f(_r,{children:"Favorites"}),n.length>0&&f(Ep,{children:f(Pp,{children:n.length})})]})})]}),I(Bw,{children:[f(Uw,{onClick:()=>{t()},src:"./img/add.png"}),r.length>0?f(Ep,{children:f(Pp,{children:r.length})}):null]})]})},Vw=y.div`
width: 100%;
display: flex;
justify-content: center;
flex-direction: column;
...
`,zi=()=>I(Xw,{children:[f(ek,{children:f(Jw,{src:"./img/logo.jfif"})}),f(ik,{}),I(tk,{children:[I(nk,{children:[f(ou,{children:"GITHUB"}),f(ou,{children:"LINKEDIN"}),f(ou,{children:"PORTIFOLIO"})]}),f(ok,{}),I(rk,{children:[f(Ea,{children:"WHO WE ARE"}),f(Ea,{children:"CONTACT"}),f(Ea,{children:"SIKE LIMITED"}),f(Ea,{children:"JUST DO THAT"})]})]})]}),ak=y.img`
width:20px;
height: 20px;
padding:3px;
cursor: pointer;
...
font-weight: 500;
text-decoration: underline;
`,wk={width:"80px"},kk=({data:e,variacoes:t,state:n,setState:r})=>(b.useState(!1),b.useState(),f(lk,{children:I(uk,{children:[f(vk,{children:f(yk,{children:"MAIS VENDIDOS"})}),f(ck,{children:e.map(i=>I(dk,{children:[f(fk,{children:f(pk,{src:i.url})}),f(hk,{children:i.colecao}),I(mk,{children:[i.preço.toFixed(2)," R$"]}),f(gk,{children:f(Tt,{style:wk,to:"/FootWear",children:f(xk,{children:"Ver item"})})})]},i.id))})]})})),Sk=y.div`
width: 100vw;
height: 500px;
display: flex;
justify-content: flex-end;
...
`,L2=y.div`
width: 100%;
`,F2=()=>(b.useContext(on),I(z2,{children:[f($2,{children:f(xr,{})}),I(M2,{children:[f(Gw,{images:D2}),f(Yw,{}),f(kk,{variacoes:j2,data:I2}),f(Rk,{}),f(L2,{children:f(zi,{})})]})]})),B2=y.div`
width:100vw;    
height: 100vh;
overflow-x: hidden;  
display: flex;
...
width: 120px;
height: 20px;
`,Y2=({data:e,variacoes:t})=>{const[n,r]=b.useState(!1),[i,o]=b.useState();return b.useContext(on),I(B2,{children:[f(U2,{children:f(xr,{})}),n?f(Jo,{variacoes:t,state:n,setState:r,item:i}):null,I(V2,{children:[e.map(a=>I(H2,{children:[I(W2,{children:[f(Z2,{src:a.url}),f(Q2,{src:a.urlSubImage})]}),f(G2,{children:a.colecao}),I(q2,{children:[a.preço.toFixed(2)," R$"]}),I(K2,{children:[f(vl,{setItem:o,state:n,setState:r,item:a}),f(gl,{item:a})]})]},a.id)),f(zi,{})]})]})},X2=y.div`
display: flex;
width:100vw;
height: 100vh;
overflow-x: hidden;  
...
height: 20px;
gap: 10px;
`,l_=({data:e,variacoes:t})=>{const[n,r]=b.useState(!1),[i,o]=b.useState();return I(X2,{children:[f(J2,{children:f(xr,{})}),n?f(Jo,{variacoes:t,state:n,setState:r,item:i}):null,I(e_,{children:[e.map(a=>I(t_,{children:[I(n_,{children:[f(r_,{src:a.url}),f(i_,{src:a.urlSubImage})]}),f(o_,{children:a.colecao}),I(a_,{children:[a.preço.toFixed(2)," R$"]}),I(s_,{children:[f(vl,{setItem:o,state:n,setState:r,item:a}),f(gl,{item:a})]})]},a.id)),f(zi,{})]})]})},u_=y.div`
display: flex;
width:100vw;
height: 100vh;
overflow-x: hidden;  
