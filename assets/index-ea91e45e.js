 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(H,Q){var le=H.length;H.push(Q);e:for(;0<le;){var k=le-1>>>1,S=H[k];if(0<i(S,Q))H[k]=Q,H[le]=S,le=k;else break e}}function n(H){return H.length===0?null:H[0]}function r(H){if(H.length===0)return null;var Q=H[0],le=H.pop();if(le!==Q){H[0]=le;e:for(var k=0,S=H.length,y=S>>>1;k<y;){var b=2*(k+1)-1,F=H[b],_=b+1,K=H[_];if(0>i(F,le))_<S&&0>i(K,F)?(H[k]=K,H[_]=le,k=_):(H[k]=F,H[b]=le,k=b);else if(_<S&&0>i(K,le))H[k]=K,H[_]=le,k=_;else break e}}return Q}function i(H,Q){var le=H.sortIndex-Q.sortIndex;return le!==0?le:H.id-Q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],d=1,p=null,g=3,T=!1,C=!1,f=!1,O=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(H){for(var Q=n(u);Q!==null;){if(Q.callback===null)r(u);else if(Q.startTime<=H)r(u),Q.sortIndex=Q.expirationTime,t(l,Q);else break;Q=n(u)}}function P(H){if(f=!1,v(H),!C)if(n(l)!==null)C=!0,Fe(A);else{var Q=n(u);Q!==null&&Ae(P,Q.startTime-H)}}function A(H,Q){C=!1,f&&(f=!1,m(W),W=-1),T=!0;var le=g;try{for(v(Q),p=n(l);p!==null&&(!(p.expirationTime>Q)||H&&!Re());){var k=p.callback;if(typeof k=="function"){p.callback=null,g=p.priorityLevel;var S=k(p.expirationTime<=Q);Q=e.unstable_now(),typeof S=="function"?p.callback=S:p===n(l)&&r(l),v(Q)}else r(l);p=n(l)}if(p!==null)var y=!0;else{var b=n(u);b!==null&&Ae(P,b.startTime-Q),y=!1}return y}finally{p=null,g=le,T=!1}}var U=!1,D=null,W=-1,ce=5,J=-1;function Re(){return!(e.unstable_now()-J<ce)}function ie(){if(D!==null){var H=e.unstable_now();J=H;var Q=!0;try{Q=D(!0,H)}finally{Q?oe():(U=!1,D=null)}}else U=!1}var oe;if(typeof c=="function")oe=function(){c(ie)};else if(typeof MessageChannel<"u"){var ve=new MessageChannel,Se=ve.port2;ve.port1.onmessage=ie,oe=function(){Se.postMessage(null)}}else oe=function(){O(ie,0)};function Fe(H){D=H,U||(U=!0,oe())}function Ae(H,Q){W=O(function(){H(e.unstable_now())},Q)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(H){H.callback=null},e.unstable_continueExecution=function(){C||T||(C=!0,Fe(A))},e.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ce=0<H?Math.floor(1e3/H):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(H){switch(g){case 1:case 2:case 3:var Q=3;break;default:Q=g}var le=g;g=Q;try{return H()}finally{g=le}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(H,Q){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var le=g;g=H;try{return Q()}finally{g=le}},e.unstable_scheduleCallback=function(H,Q,le){var k=e.unstable_now();switch(typeof le=="object"&&le!==null?(le=le.delay,le=typeof le=="number"&&0<le?k+le:k):le=k,H){case 1:var S=-1;break;case 2:S=250;break;case 5:S=1073741823;break;case 4:S=1e4;break;default:S=5e3}return S=le+S,H={id:d++,callback:Q,priorityLevel:H,startTime:le,expirationTime:S,sortIndex:-1},le>k?(H.sortIndex=le,t(u,H),n(l)===null&&H===n(u)&&(f?(m(W),W=-1):f=!0,Ae(P,le-k))):(H.sortIndex=S,t(l,H),C||T||(C=!0,Fe(A))),H},e.unstable_shouldYield=Re,e.unstable_wrapCallback=function(H){var Q=g;return function(){var le=g;g=Q;try{return H.apply(this,arguments)}finally{g=le}}}})(lh);(function(e){e.exports=lh})(Dg);/**
 * @license React
...
`),r=[],i=0,o=n.length;i<o;i++){var a=n[i].trim();if(a){var s=a.match(Fx);if(s){var l=0|parseInt(s[1],10),u=s[2];l!==0&&(zx(u,l),Ux(e,u,s[3]),e.getTag().insertRules(l,r)),r.length=0}else r.push(a)}}},Vx=function(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null},P0=function(e){var t=document.head,n=e||t,r=document.createElement("style"),i=function(s){for(var l=s.childNodes,u=l.length;u>=0;u--){var d=l[u];if(d&&d.nodeType===1&&d.hasAttribute(Ii))return d}}(n),o=i!==void 0?i.nextSibling:null;r.setAttribute(Ii,"active"),r.setAttribute("data-styled-version","5.3.9");var a=Vx();return a&&r.setAttribute("nonce",a),n.insertBefore(r,o),r},Hx=function(){function e(n){var r=this.element=P0(n);r.appendChild(document.createTextNode("")),this.sheet=function(i){if(i.sheet)return i.sheet;for(var o=document.styleSheets,a=0,s=o.length;a<s;a++){var l=o[a];if(l.ownerNode===i)return l}sa(17)}(r),this.length=0}var t=e.prototype;return t.insertRule=function(n,r){try{return this.sheet.insertRule(r,n),this.length++,!0}catch{return!1}},t.deleteRule=function(n){this.sheet.deleteRule(n),this.length--},t.getRule=function(n){var r=this.sheet.cssRules[n];return r!==void 0&&typeof r.cssText=="string"?r.cssText:""},e}(),Zx=function(){function e(n){var r=this.element=P0(n);this.nodes=r.childNodes,this.length=0}var t=e.prototype;return t.insertRule=function(n,r){if(n<=this.length&&n>=0){var i=document.createTextNode(r),o=this.nodes[n];return this.element.insertBefore(i,o||null),this.length++,!0}return!1},t.deleteRule=function(n){this.element.removeChild(this.nodes[n]),this.length--},t.getRule=function(n){return n<this.length?this.nodes[n].textContent:""},e}(),Wx=function(){function e(n){this.rules=[],this.length=0}var t=e.prototype;return t.insertRule=function(n,r){return n<=this.length&&(this.rules.splice(n,0,r),this.length++,!0)},t.deleteRule=function(n){this.rules.splice(n,1),this.length--},t.getRule=function(n){return n<this.length?this.rules[n]:""},e}(),Cp=Md,Kx={isServer:!Md,useCSSOMInjection:!jx},T0=function(){function e(n,r,i){n===void 0&&(n=dr),r===void 0&&(r={}),this.options=In({},Kx,{},n),this.gs=r,this.names=new Map(i),this.server=!!n.isServer,!this.server&&Md&&Cp&&(Cp=!1,function(o){for(var a=document.querySelectorAll(Mx),s=0,l=a.length;s<l;s++){var u=a[s];u&&u.getAttribute(Ii)!=="active"&&(Bx(o,u),u.parentNode&&u.parentNode.removeChild(u))}}(this))}e.registerId=function(n){return Aa(n)};var t=e.prototype;return t.reconstructWithOptions=function(n,r){return r===void 0&&(r=!0),new e(In({},this.options,{},n),this.gs,r&&this.names||void 0)},t.allocateGSInstance=function(n){return this.gs[n]=(this.gs[n]||0)+1},t.getTag=function(){return this.tag||(this.tag=(i=(r=this.options).isServer,o=r.useCSSOMInjection,a=r.target,n=i?new Wx(a):o?new Hx(a):new Zx(a),new $x(n)));var n,r,i,o,a},t.hasNameForId=function(n,r){return this.names.has(n)&&this.names.get(n).has(r)},t.registerName=function(n,r){if(Aa(n),this.names.has(n))this.names.get(n).add(r);else{var i=new Set;i.add(r),this.names.set(n,i)}},t.insertRules=function(n,r,i){this.registerName(n,r),this.getTag().insertRules(Aa(n),i)},t.clearNames=function(n){this.names.has(n)&&this.names.get(n).clear()},t.clearRules=function(n){this.getTag().clearGroup(Aa(n)),this.clearNames(n)},t.clearTag=function(){this.tag=void 0},t.toString=function(){return function(n){for(var r=n.getTag(),i=r.length,o="",a=0;a<i;a++){var s=Lx(a);if(s!==void 0){var l=n.names.get(s),u=r.getGroup(a);if(l&&u&&l.size){var d=Ii+".g"+a+'[id="'+s+'"]',p="";l!==void 0&&l.forEach(function(g){g.length>0&&(p+=g+",")}),o+=""+u+d+'{content:"'+p+`"}/*!sc*/
`}}}return o}(this)},e}(),Qx=/(a)(d)/gi,Pp=function(e){return String.fromCharCode(e+(e>25?39:97))};function kc(e){var t,n="";for(t=Math.abs(e);t>52;t=t/52|0)n=Pp(t%52)+n;return(Pp(t%52)+n).replace(Qx,"$1-$2")}var mi=function(e,t){for(var n=t.length;n;)e=33*e^t.charCodeAt(--n);return e},b0=function(e){return mi(5381,e)};function qx(e){for(var t=0;t<e.length;t+=1){var n=e[t];if(Mo(n)&&!zd(n))return!1}return!0}var Yx=b0("5.3.9"),Gx=function(){function e(t,n,r){this.rules=t,this.staticRulesId="",this.isStatic=(r===void 0||r.isStatic)&&qx(t),this.componentId=n,this.baseHash=mi(Yx,n),this.baseStyle=r,T0.registerId(n)}return e.prototype.generateAndInjectStyles=function(t,n,r){var i=this.componentId,o=[];if(this.baseStyle&&o.push(this.baseStyle.generateAndInjectStyles(t,n,r)),this.isStatic&&!r.hash)if(this.staticRulesId&&n.hasNameForId(i,this.staticRulesId))o.push(this.staticRulesId);else{var a=Di(this.rules,t,n,r).join(""),s=kc(mi(this.baseHash,a)>>>0);if(!n.hasNameForId(i,s)){var l=r(a,"."+s,void 0,i);n.insertRules(i,s,l)}o.push(s),this.staticRulesId=s}else{for(var u=this.rules.length,d=mi(this.baseHash,r.hash),p="",g=0;g<u;g++){var T=this.rules[g];if(typeof T=="string")p+=T;else if(T){var C=Di(T,t,n,r),f=Array.isArray(C)?C.join(""):C;d=mi(d,f+g),p+=f}}if(p){var O=kc(d>>>0);if(!n.hasNameForId(i,O)){var m=r(p,"."+O,void 0,i);n.insertRules(i,O,m)}o.push(O)}}return o.join(" ")},e}(),Xx=/^\s*\/\/.*$/gm,Jx=[":","[",".","#"];function ew(e){var t,n,r,i,o=e===void 0?dr:e,a=o.options,s=a===void 0?dr:a,l=o.plugins,u=l===void 0?_s:l,d=new vx(s),p=[],g=function(f){function O(m){if(m)try{f(m+"}")}catch{}}return function(m,c,v,P,A,U,D,W,ce,J){switch(m){case 1:if(ce===0&&c.charCodeAt(0)===64)return f(c+";"),"";break;case 2:if(W===0)return c+"/*|*/";break;case 3:switch(W){case 102:case 112:return f(v[0]+c),"";default:return c+(J===0?"/*|*/":"")}case-2:c.split("/*|*/}").forEach(O)}}}(function(f){p.push(f)}),T=function(f,O,m){return O===0&&Jx.indexOf(m[n.length])!==-1||m.match(i)?f:"."+t};function C(f,O,m,c){c===void 0&&(c="&");var v=f.replace(Xx,""),P=O&&m?m+" "+O+" { "+v+" }":v;return t=c,n=O,r=new RegExp("\\"+n+"\\b","g"),i=new RegExp("(\\"+n+"\\b){2,}"),d(m||!O?"":O,P)}return d.use([].concat(u,[function(f,O,m){f===2&&m.length&&m[0].lastIndexOf(n)>0&&(m[0]=m[0].replace(r,T))},g,function(f){if(f===-2){var O=p;return p=[],O}}])),C.hash=u.length?u.reduce(function(f,O){return O.name||sa(15),mi(f,O.name)},5381).toString():"",C}var R0=Nt.createContext();R0.Consumer;var O0=Nt.createContext(),tw=(O0.Consumer,new T0),_c=ew();function nw(){return $.useContext(R0)||tw}function rw(){return $.useContext(O0)||_c}var iw=function(){function e(t,n){var r=this;this.inject=function(i,o){o===void 0&&(o=_c);var a=r.name+o.hash;i.hasNameForId(r.id,a)||i.insertRules(r.id,a,o(r.rules,a,"@keyframes"))},this.toString=function(){return sa(12,String(r.name))},this.name=t,this.id="sc-keyframes-"+t,this.rules=n}return e.prototype.getName=function(t){return t===void 0&&(t=_c),this.name+t.hash},e}(),ow=/([A-Z])/,aw=/([A-Z])/g,sw=/^ms-/,lw=function(e){return"-"+e.toLowerCase()};function Tp(e){return ow.test(e)?e.replace(aw,lw).replace(sw,"-ms-"):e}var bp=function(e){return e==null||e===!1||e===""};function Di(e,t,n,r){if(Array.isArray(e)){for(var i,o=[],a=0,s=e.length;a<s;a+=1)(i=Di(e[a],t,n,r))!==""&&(Array.isArray(i)?o.push.apply(o,i):o.push(i));return o}if(bp(e))return"";if(zd(e))return"."+e.styledComponentId;if(Mo(e)){if(typeof(u=e)!="function"||u.prototype&&u.prototype.isReactComponent||!t)return e;var l=e(t);return Di(l,t,n,r)}var u;return e instanceof iw?n?(e.inject(n,r),e.getName(r)):e:Sc(e)?function d(p,g){var T,C,f=[];for(var O in p)p.hasOwnProperty(O)&&!bp(p[O])&&(Array.isArray(p[O])&&p[O].isCss||Mo(p[O])?f.push(Tp(O)+":",p[O],";"):Sc(p[O])?f.push.apply(f,d(p[O],O)):f.push(Tp(O)+": "+(T=O,(C=p[O])==null||typeof C=="boolean"||C===""?"":typeof C!="number"||C===0||T in yx?String(C).trim():C+"px")+";"));return g?[g+" {"].concat(f,["}"]):f}(e):e.toString()}var Rp=function(e){return Array.isArray(e)&&(e.isCss=!0),e};function uw(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return Mo(e)||Sc(e)?Rp(Di(_p(_s,[e].concat(n)))):n.length===0&&e.length===1&&typeof e[0]=="string"?e:Rp(Di(_p(e,n)))}var cw=function(e,t,n){return n===void 0&&(n=dr),e.theme!==n.theme&&e.theme||t||n.theme},dw=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,fw=/(^-|-$)/g;function lu(e){return e.replace(dw,"-").replace(fw,"")}var pw=function(e){return kc(b0(e)>>>0)};function Na(e){return typeof e=="string"&&!0}var Ec=function(e){return typeof e=="function"||typeof e=="object"&&e!==null&&!Array.isArray(e)},hw=function(e){return e!=="__proto__"&&e!=="constructor"&&e!=="prototype"};function mw(e,t,n){var r=e[n];Ec(t)&&Ec(r)?A0(r,t):e[n]=t}function A0(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];for(var i=0,o=n;i<o.length;i++){var a=o[i];if(Ec(a))for(var s in a)hw(s)&&mw(e,a[s],s)}return e}var N0=Nt.createContext();N0.Consumer;var uu={};function I0(e,t,n){var r=zd(e),i=!Na(e),o=t.attrs,a=o===void 0?_s:o,s=t.componentId,l=s===void 0?function(c,v){var P=typeof c!="string"?"sc":lu(c);uu[P]=(uu[P]||0)+1;var A=P+"-"+pw("5.3.9"+P+uu[P]);return v?v+"-"+A:A}(t.displayName,t.parentComponentId):s,u=t.displayName,d=u===void 0?function(c){return Na(c)?"styled."+c:"Styled("+Ep(c)+")"}(e):u,p=t.displayName&&t.componentId?lu(t.displayName)+"-"+t.componentId:t.componentId||l,g=r&&e.attrs?Array.prototype.concat(e.attrs,a).filter(Boolean):a,T=t.shouldForwardProp;r&&e.shouldForwardProp&&(T=t.shouldForwardProp?function(c,v,P){return e.shouldForwardProp(c,v,P)&&t.shouldForwardProp(c,v,P)}:e.shouldForwardProp);var C,f=new Gx(n,p,r?e.componentStyle:void 0),O=f.isStatic&&a.length===0,m=function(c,v){return function(P,A,U,D){var W=P.attrs,ce=P.componentStyle,J=P.defaultProps,Re=P.foldedComponentIds,ie=P.shouldForwardProp,oe=P.styledComponentId,ve=P.target,Se=function(F,_,K){F===void 0&&(F=dr);var j=In({},_,{theme:F}),Pe={};return K.forEach(function(he){var me,re,Oe,ye=he;for(me in Mo(ye)&&(ye=ye(j)),ye)j[me]=Pe[me]=me==="className"?(re=Pe[me],Oe=ye[me],re&&Oe?re+" "+Oe:re||Oe):ye[me]}),[j,Pe]}(cw(A,$.useContext(N0),J)||dr,A,W),Fe=Se[0],Ae=Se[1],H=function(F,_,K,j){var Pe=nw(),he=rw(),me=_?F.generateAndInjectStyles(dr,Pe,he):F.generateAndInjectStyles(K,Pe,he);return me}(ce,D,Fe),Q=U,le=Ae.$as||A.$as||Ae.as||A.as||ve,k=Na(le),S=Ae!==A?In({},A,{},Ae):A,y={};for(var b in S)b[0]!=="$"&&b!=="as"&&(b==="forwardedAs"?y.as=S[b]:(ie?ie(b,xp,le):!k||xp(b))&&(y[b]=S[b]));return A.style&&Ae.style!==A.style&&(y.style=In({},A.style,{},Ae.style)),y.className=Array.prototype.concat(Re,oe,H!==oe?H:null,A.className,Ae.className).filter(Boolean).join(" "),y.ref=Q,$.createElement(le,y)}(C,c,v,O)};return m.displayName=d,(C=Nt.forwardRef(m)).attrs=g,C.componentStyle=f,C.displayName=d,C.shouldForwardProp=T,C.foldedComponentIds=r?Array.prototype.concat(e.foldedComponentIds,e.styledComponentId):_s,C.styledComponentId=p,C.target=r?e.target:e,C.withComponent=function(c){var v=t.componentId,P=function(U,D){if(U==null)return{};var W,ce,J={},Re=Object.keys(U);for(ce=0;ce<Re.length;ce++)W=Re[ce],D.indexOf(W)>=0||(J[W]=U[W]);return J}(t,["componentId"]),A=v&&v+"-"+(Na(c)?c:lu(Ep(c)));return I0(c,In({},P,{attrs:g,componentId:A}),n)},Object.defineProperty(C,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(c){this._foldedDefaultProps=r?A0({},e.defaultProps,c):c}}),Object.defineProperty(C,"toString",{value:function(){return"."+C.styledComponentId}}),i&&Dx(C,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0,withComponent:!0}),C}var Cc=function(e){return function t(n,r,i){if(i===void 0&&(i=dr),!ks.isValidElementType(r))return sa(1,String(r));var o=function(){return n(r,i,uw.apply(void 0,arguments))};return o.withConfig=function(a){return t(n,r,In({},i,{},a))},o.attrs=function(a){return t(n,r,In({},i,{attrs:Array.prototype.concat(i.attrs,a).filter(Boolean)}))},o}(I0,e)};["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","textPath","tspan"].forEach(function(e){Cc[e]=Cc(e)});const w=Cc;var Pc={},gw={get exports(){return Pc},set exports(e){Pc=e}},D0={};/**
 * @license React
...
color: white;
margin-top: 3px;
`,Sr=()=>{const{favorito:e}=$.useContext(ol),t=Tl(),{cartIsOpen:n}=Fo(o=>o.cartReducer),{products:r}=Fo(o=>o.cartReducer),i=()=>{t(Yw())};return V(ES,{children:[n?h(_S,{}):null,h(CS,{children:h(zt,{to:"/",style:Zn,children:h(TS,{src:"./img/logo.jfif"})})}),V(PS,{children:[h(zt,{to:"/",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/house.png"}),h(Cr,{children:"Home"})]})}),h(zt,{to:"/Perfil",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/account.png"}),h(Cr,{children:"Profile"})]})}),h(zt,{to:"/Camisas",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/shirt.png"}),h(Cr,{children:"Tshirts"})]})}),h(zt,{to:"/Bermudas",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/shorts.png"}),h(Cr,{children:"Bermudas"})]})}),h(zt,{to:"/FootWear",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/shoes.png"}),h(Cr,{children:"FootWear"})]})}),h(zt,{to:"/HeadWear",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/cap.png"}),h(Cr,{children:"Headwear"})]})}),h(zt,{to:"/Favorites",style:Zn,children:V(_r,{children:[h(Er,{src:"./img/heart-full.png"}),h(Cr,{children:"Favorites"}),e.length>0&&h(Ap,{children:h(Np,{children:e.length})})]})})]}),V(bS,{children:[h(RS,{onClick:i,src:"./img/add.png"}),r.length>0?h(Ap,{children:h(Np,{children:r.length})}):null]})]})},OS=w.div`
width: 100%;
display: flex;
justify-content: center;
flex-direction: column;
...
`,Yr=({item:e})=>{const t=Tl();return h(Yn,{children:h(WS,{onClick:()=>{t(qw(e))},src:"./img/add.png"})})},KS=w.div`
width: 80vw;
display: flex;
position: relative;
...
padding: 10px;
border-radius: 5px;
`,bl=({item:e})=>{const{toggleStateDetalhes:t}=$.useContext(Bi);return h(Sk,{children:V(kk,{children:[h(_k,{children:h(Ik,{onClick:t,src:"./img/close.png"})}),V(Ek,{children:[V(Ck,{children:[h(Pk,{src:e.url}),h(Tk,{children:e.nome}),h(bk,{children:`- ${e.colecao} -`})]}),V(Ok,{children:[h(Ak,{children:h(Rk,{children:e.descricao})}),V(Nk,{children:[V(jk,{children:[h($k,{children:"Tamanho: Padrão"}),h(Lk,{children:"Cor: Padrão"})]}),V(Dk,{children:[h(Yr,{item:e}),h(qr,{item:e})]})]})]})]},e.id)]})})},zk=w.div`
width:100vw;    
height: 100vh;
overflow-x: hidden;  
display: flex;
...
width: 120px;
height: 20px;
`,Kk=({data:e})=>{const{defineItem:t,isOpen:n,qualItem:r}=$.useContext(Bi);return V(zk,{children:[n?h(bl,{item:r}):null,h(Mk,{children:h(Sr,{})}),V(Fk,{children:[e.map(i=>V(Uk,{children:[h(Bk,{children:h(Vk,{onClick:()=>{t(i)},src:i.url})}),h(Hk,{children:i.colecao}),V(Zk,{children:[i.preço.toFixed(2)," R$"]}),V(Wk,{children:[h(Yr,{item:i}),h(qr,{item:i})]})]},i.id)),h(Ui,{})]})]})},Qk=w.div`
display: flex;
width:100vw;
height: 100vh;
overflow-x: hidden;  
...
height: 20px;
gap: 10px;
`,p_=({data:e})=>{const{defineItem:t,isOpen:n,qualItem:r}=$.useContext(Bi);return V(i_,{children:[h(o_,{children:h(Sr,{})}),n?h(bl,{item:r}):null,V(a_,{children:[e.map(i=>V(s_,{children:[h(l_,{children:h(u_,{onClick:()=>{t(i)},src:i.url})}),h(c_,{children:i.colecao}),V(d_,{children:[i.preço.toFixed(2)," R$"]}),V(f_,{children:[h(Yr,{item:i}),h(qr,{item:i})]})]},i.id)),h(Ui,{})]})]})},h_=w.div`
display: flex;
width:100vw;
height: 100vh;
overflow-x: hidden;  
